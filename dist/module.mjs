...
function autoAddMiddleware(pages, middlewareName) {
  for (const page of pages) {
    if (page.meta !== void 0 && (page.meta.auth === true || typeof page.meta.auth === "object")) {
      const previousMiddleware = page.meta.middleware;
      let normalizedMiddleware;
      if (previousMiddleware === void 0) {
